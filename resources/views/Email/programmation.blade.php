...
<div class="container">
    ...
    <table>
                ...
                <tr>
                    <td>{{date_format(date_create($programmations->dateprogrammer),'d/m/Y')}}</td>
                    <td>{{$programmations->immatriculationTracteur}}</td>
                    <td>{{$programmations->produit}}</td>
                    <td>{{$programmations->qteprogrammer}}</td>
                    <td>{{$programmations->chauffeur}}</td>
                    <td>{{$programmations->avaliseur}}</td>
                </tr>
                </tbody>
            </table>
    ...
    <div class="button-container">
        <a href="{{$lienAction}}" class="button">Cliquez ici pour réceptionner</a>
    </div>
</div>
