...
<div class="container">
    ...
    <h3>Statistique des ventes en attente de traitement.</h3>
    <table>
        <tr>
            <th>Date vente</th>
            <th>Nombre</th>
        ...
        @foreach($venteAttentes as $item)
            <tr>
                <th>{{date_format(date_create($item->date),'d/m/Y')}}</th>
                <th>{{$item->nombre}}</th>
                <th><a href="#">Consulter</a></th>
            </tr>
        @endforeach
    </table>
