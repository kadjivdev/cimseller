                    ...
                    <div class="col-md-6">
                        <div class="card card-warning bg-warning">
                            <div class="card-header">
                                <h3 class="card-title">Suppression d'accuse de document</h3>
                            </div>
                                <div class="card-body">
                                    Êtes vous sûr de vouloir supprimer l'accuse de document N° : {{ $accusedocument->code }}
                                </div>
                                <div class="card-footer">
                                    <div class="row justify-content-center">
                                        <div class="col-sm-4">
                                            <a href="{{ route('accusedocuments.index', ['boncommandes' =>$boncommandes]) }}" class="btn btn-sm btn-secondary btn-block">
                                                <i class="fa-solid fa-circle-left"></i>
                                                {{ __('Retour') }}
                                            </a>
                                        </div>
                                        <div class="col-sm-4">
                                            <a class="btn btn-sm btn-success btn-block"  href="{{ route('accusedocuments.destroy', ['boncommande'=>$boncommandes->id, 'accusedocument'=>$accusedocument]) }}">
                                                {{ __('Supprimer') }}
