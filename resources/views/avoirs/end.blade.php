                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-3">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Dissocier agent</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <section class="content">
                                <div class="card alert-warning">
                                    <div class="card-header">
                                        <h3 class="card-title">Clôture de contrat de l'agent {{  $agent->matricule.' '.$agent->nom.' '.$agent->prenom  }} </h3>
                                    </div>
                                    <form  method="POST" action="{{ route('appartenirs.done') }}">
                                        @csrf
                                        <div class="card-body">
                                            Êtes vous vraiment sûr de vouloir mettre fin au contrat de l'agent de la société: {{  $societe->sigle.' '.$societe->raisonSociale  }}
