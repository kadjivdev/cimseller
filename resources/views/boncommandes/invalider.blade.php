    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h1 class="pb-3">ANNULATION DE LA VALIDATION DE BON DE COMMANDE</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="card card-warning bg-warning">
                                <div class="card-body text-center">
                                    <h4>Voulez vous annuler la validation du bon de commande N° {{ $boncommandes->code }} de {{ $boncommandes->fournisseur->sigle }} ?</h4>
                                </div>
