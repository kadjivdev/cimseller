                    ...
                    <div class="col-md-12">
                        <div class="card card-success bg-success">
                                <div class="card-body text-center">
                                    <h4>Voulez vous retouner le bon de commande N° {{ $boncommandes->code }} de {{ $boncommandes->fournisseur->sigle }} ?</h4>
                                </div>
                                <div class="card-footer">
                                    <div class="row justify-content-center">
                                        <div class="col-sm-4"></div>
                                        <div class="col-sm-4 text-center">
                                            <form method="POST" action="{{ route('boncommandes.retourner', ['boncommandes'=>$boncommandes->id]) }}" id="validerForm">
                                            @csrf
