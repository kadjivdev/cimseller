                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Listes des camions</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    ...
                                    <a class="btn btn-success btn-sm" href="{{route('camions.create')}}">
                                        ...
                                        @if ($camions->count() > 0)
                                            ...
                                            @foreach($camions as $camion)
                                                <tr>
                                                    ...
                                                    <td>{{ $camion->avaliseur->nom }} {{ $camion->avaliseur->prenom }} ({{ $camion->avaliseur->typeavaliseur->libelle }})</td>
                                                    ...
                                                    <td class="text-center" width="130px">
                                                        <a class="btn btn-success btn-sm" href="{{ route('camions.show', ['id'=>$camion->id]) }}"><i class="fa-regular fa-eye"></i></a>
                                                        <a class="btn btn-warning btn-sm" href="{{ route('camions.edit', ['id'=>$camion->id]) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                                        <a class="btn btn-danger btn-sm" href="{{ route('camions.delete', ['id'=>$camion->id]) }}"><i class="fa-solid fa-trash-can"></i></a>
                                                    ...
                                                    <td class="text-center" >
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-md-right dropdown-menu-icon-list drop text-sm">
                                                                ...
                                                                <a class="dropdown-item" href="{{ route('assurances.index', ['id'=>$camion->id]) }}"><i class="fa-solid fa-car-burst"></i> Assurances</a>
                                                                <a class="dropdown-item" href="{{ route('visitetechniques.index', ['id'=>$camion->id]) }}"><i class="fa-solid fa-car-on"></i> Visite Technique</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
