    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>AGENTS  AFFECTER A  {{ $client->raisonSociale }} </h1>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <div class="modal fade" id="modal-default">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{route('newclient.affectionAgent')}} ">
                                            @csrf                                            
                                ...
                                <table id="example1" class="table table-bordered table-striped table-sm"  style="font-size: 12px">
                                    ...
                                    @if ($Porteuilles->count() > 0)
                                        ...
                                        @foreach($Porteuilles as $Porteuille)
                                            <tr>
                                                <td>{{ $compteur++ }}</td>
                                                <td class="ml-5 pr-5">{{ $Porteuille->nom }}</td>
                                                <td class="ml-5 pr-5">{{ $Porteuille->prenom }}</td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a class=" @if ($Porteuille->statut == 1) badge badge-success @else  badge badge-danger @endif " >@if ($Porteuille->statut == 1) Activer @else  Désactiver @endif</a>
                                                </td>
