                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <ul class="m-4 mb-0 fa-ul text-muted text-md">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <b><li class=""><span class="fa-li"><i class="fa-regular fa-closed-captioning"></i></span>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <li class=""><span class="fa-li"><i class="fa-solid fa-industry"></i></span> Type : @if($commandeclient->client->typeclient ) {{ $commandeclient->client->typeclient->libelle }} @endif</li>
                                            </div>
                                        </div>
                                    </ul>
                                </div>
