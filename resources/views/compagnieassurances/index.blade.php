    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Compagnies d'assurance</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Acceuil</a></li>
                            <li class="breadcrumb-item active">Liste des compagnies d'assurances</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        @endif
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Nouveau Compagnie Assurance</h4>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form method="POST" action="{{ route('compagnieassurances.store') }}">
                                            @csrf
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label>Libellé<span class="text-danger">*</span></label>
                                                        <input type="text" id="libelle" class="form-control form-control-sm @error('libelle') is-invalid @enderror" name="libelle" style="text-transform: uppercase"  value="{{ old('libelle') }}" autocomplete="off" autofocus required>
                                                        @error('libelle')
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped table-sm"  style="font-size: 12px">
                                    ...
                                    <tbody>
                                    @if ($compagnieassurances->count() > 0)
                                        <?php $compteur=1; ?>
                                        @foreach($compagnieassurances as $compagnieassurance)
                                            <tr>
                                                <td>{{ $compteur++ }}</td>
                                                <td class="ml-5 pr-5">{{ $compagnieassurance->libelle }}</td>
                                                <td class="text-center">
                                                    <!--<a class="btn btn-success btn-sm" href="#"><i class="fa-regular fa-eye"></i></a>-->
                                                    <a class="btn btn-warning btn-sm" href="{{ route('compagnieassurances.edit', ['compagnieassurance'=>$compagnieassurance->id])  }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                                    <a class="btn btn-danger btn-sm" href="{{ route('compagnieassurances.delete', ['compagnieassurance'=>$compagnieassurance->id])  }}"><i class="fa-solid fa-trash-can"></i></a>
                                                </td>
