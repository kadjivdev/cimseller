                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Listes des départements</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                        ...
                                        <form method="POST" action="{{ route('departements.store') }}">
                                            @csrf
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <a href="{{ route('departements.index') }}" class="btn btn-sm btn-secondary btn-block">
                                ...
                                <table id="example1" class="table table-bordered table-striped table-sm"  style="font-size: 12px">
                                    ...
                                    @if ($departements->count() > 0)
                                        ...
                                        @foreach($departements as $departement)
                                            <tr>
                                                <td>{{ $compteur++ }}</td>
                                                <td class="ml-5 pr-5">{{ $departement->libelle }}</td>
                                                <td class="text-center">
                                                    <!--<a class="btn btn-success btn-sm" href="#"><i class="fa-regular fa-eye"></i></a>-->
                                                    <a class="btn btn-warning btn-sm" href="{{ route('departements.edit', ['departement'=>$departement->id])  }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                                    <a class="btn btn-danger btn-sm" href="{{ route('departements.delete', ['departement'=>$departement->id])  }}"><i class="fa-solid fa-trash-can"></i></a>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-md-right dropdown-menu-icon-list drop text-sm">
                                                            <a class="dropdown-item" href="{{ route('departements.zone', ['departement'=>$departement->id])  }}"><i class="nav-icon fa-solid fa-earth-africa"></i> Zones</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
