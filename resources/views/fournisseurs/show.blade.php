        ...
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-8">
                            <h1 class="pb-3">INFO FOURNISSEUR</h1>
                                <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 text-right">
                                    <a href="{{ route('fournisseurs.index') }}" class="btn btn-sm btn-primary right"><i class="fa-solid fa-circle-left"></i> Retour</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-5 col-sm-2">
                                    <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                                        <a class="nav-link @if (session('typeajout')) {{ session('typeajout') == '1' ? 'active' : '' }} @else active @endif" id="vert-tabs-home-tab" data-toggle="pill" href="#vert-tabs-home" role="tab" aria-controls="vert-tabs-home" aria-selected="true">Produits</a>
                                        <a class="nav-link @if (session('typeajout')) {{ session('typeajout') == '2' ? 'active' : '' }}@endif" id="vert-tabs-profile-tab" data-toggle="pill" href="#vert-tabs-profile" role="tab" aria-controls="vert-tabs-profile" aria-selected="false">Interlocuteurs</a>
                                        <a class="nav-link @if (session('typeajout')) {{ session('typeajout') == '3' ? 'active' : '' }}@endif" id="vert-tabs-messages-tab" data-toggle="pill" href="#vert-tabs-messages" role="tab" aria-controls="vert-tabs-messages" aria-selected="false">Autres Téléphone</a>
                                ...
                                <div class="col-7 col-sm-10">
                                    <div class="tab-content" id="vert-tabs-tabContent">
                                        <div class="tab-pane text-left fade @if (session('typeajout')) {{ session('typeajout') == '1' ? 'show active' : '' }} @else show active @endif" id="vert-tabs-home" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                                        ...
                                        <div class="tab-pane fade @if (session('typeajout')) {{ session('typeajout') == '2' ? 'show active' : '' }}@endif" id="vert-tabs-profile" role="tabpanel" aria-labelledby="vert-tabs-profile-tab">
                                                <div class="card-header">
                                        ...
                                        <div class="tab-pane fade @if (session('typeajout')) {{ session('typeajout') == '3' ? 'show active' : '' }}@endif" id="vert-tabs-messages" role="tabpanel" aria-labelledby="vert-tabs-messages-tab">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        ...
                                                                                        <input type="number" name="numero" class="form-control form-control-sm @error('numero') is-invalid @enderror"  value="{{ old('numero') }}" required autocomplete="numero">
                                                                                        @error('numero')
                                                                                            <span class="text-danger">{{ $message }}</span>
                                                                                        @enderror
                                                                                    </div>
