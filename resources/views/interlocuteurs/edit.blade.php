                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm  @error('qualification') is-invalid @enderror" name="qualification" style="text-transform: capitalize"  value="{{ @old('qualification')? @old('qualification'):$interlocuteurs->qualification }}"  autocomplete="qualification" autofocus required>
                                                @error('qualification')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
