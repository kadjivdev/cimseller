                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Modification prix</li>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-secondary">
                            ...
                            <div class="card-header">
                                ...
                                <h3 class="card-title">Modification prix</h3>

                            </div>

                            <form method="POST" action="{{ route('prix.update', ['prix'=>$prix->id]) }}">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="Date" id="datePriseEffet"
                                                    ...
                                                    value="{{ @old('datePriseEffet')?@old('datePriseEffet'):$prix->datePriseEffet }}" autocomplete="datePriseEffet" autofocus required>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="Date" id="dateFin"
                                                    ...
                                                    value="{{ @old('dateFin')?@old('dateFin'):$prix->dateFin }}" autocomplete="dateFin" autofocus required>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="prix"
                                                    ...
                                                    value="{{ @old('prix')?@old('prix'):$prix->prix }}" autocomplete="prix" autofocus required>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    <option value="{{ $prix->zone->id }}" selected>{{ $prix->zone->libelle }}</option>
