                    ...
                    <div class="col-md-12 mb-3">
                        <div class="card card-success bg-success">
                                <div class="card-body text-center">
                                    <h4>Voulez vous valider la programmation N° {{ $programmation->code }} du camion {{ $programmation->camion->marque->libelle }} ({{ $programmation->camion->immatriculationTracteur }}, {{ $programmation->camion->immatriculationRemorque }}) à la date du {{ date_format(date_create($programmation->dateprogrammer), 'd/m/Y') }} ?</h4>
                                </div>
