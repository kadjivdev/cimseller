                                        ...
                                        <div class="col-4" hidden>
                                            <div class="form-group">
                                                ...
                                                <select  onchange="selectReglement()" name="srcReg" class="form-select form-control" id="srcReg">
                                                    <option @if(!$reglement->typeReglement)  selected @elseif(old('srcReg') == 'indirect') selected @endif value="indirect" >Règlément par compte</option>
                                                    <option @if($reglement->typeReglement) selected @elseif(old('srcReg') == 'indirect') selected @endif value="direct">Règlément direct</option>
                                                </select>
                                                @error('srcReg')
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="compte_id" class="select2 form-control form-control-sm @error('compte_id') is-invalid @enderror" name="compte_id" style="width: 100%;">
                                                    @if ($reglement->compte == NULL)
                                                        <option value="" selected>PAS DE COMPTE EN BANQUE IMPLIQUE</option>
                                                    @else
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select id="type" class="select2 form-control form-control-sm @error('typedetailrecu_id') is-invalid @enderror" name="typedetailrecu_id" style="width: 100%;">
                                                    @if ($reglement->typeReglement == NULL)
                                                        <option value="" selected>PAS DE COMPTE EN BANQUE IMPLIQUE</option>
                                                    @else
                                                        <option value="{{ $reglement->typeReglement?$reglement->typeReglement->id:'' }}" selected>{{ $reglement->typeReglement?$reglement->typeReglement->libelle:'' }}</option>
                                                    @endif
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input id="reference" type="text" class="form-control form-control-sm" name="reference" style="text-transform: uppercase"  value="{{ @old('code')?@old('code'):$reglement->reference }}"  autocomplete="reference" autofocus>
                                                @error('reference')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                ...
                                                <input id="document" type="file" name="document" class="form-control form-control-sm @error('document') is-invalid @enderror" value="{{ @old('document')?@old('document'):$reglement->document }}" >
                                                @error('document')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
