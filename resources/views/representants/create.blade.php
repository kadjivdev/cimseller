            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Nouveau représentant</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-10">
                        <div class="card card-secondary">
                            <div class="card-header">
                                <h3 class="card-title">Ajouter un nouveau representant</h3>
                            </div>
                            <form method="POST" action="{{ route('representants.store') }}"  enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="telephonepro" class="form-control form-control-sm @error('telephonepro') is-invalid @enderror"  value="{{ old('telephonepro') }}" required autocomplete="telephonepro">
                                                    @error('telephonepro')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
