                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <label>Libellé</label>
                                                        <input type="text" class="form-control form-control-sm @error('libelle') is-invalid @enderror" style="text-transform: uppercase" name="libelle" autocomplete="libelle"  value="{{ @old('libelle')?@old('libelle'):$role->libelle }}" autofocus required>
                                                        @error('libelle')
