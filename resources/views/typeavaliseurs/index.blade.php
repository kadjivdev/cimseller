    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Types Avaliseurs</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Acceuil</a></li>
                            <li class="breadcrumb-item active">Liste des types d'avaliseurs</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        @endif
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Nouveau Type Avaliseur</h4>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form method="POST" action="{{ route('typeavaliseurs.store') }}">
                                            @csrf
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <a href="{{ route('typeavaliseurs.index') }}" class="btn btn-sm btn-secondary btn-block">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped table-sm"  style="font-size: 12px">
                                    ...
                                    <tbody>
                                    @if ($typeavaliseurs->count() > 0)
                                        <?php $compteur=1; ?>
                                        @foreach($typeavaliseurs as $typeavaliseur)
                                            <tr>
                                                <td>{{ $compteur++ }}</td>
                                                <td class="ml-5 pr-5">{{ $typeavaliseur->libelle }}</td>
                                                <td class="text-center">
                                                    <!--<a class="btn btn-success btn-sm" href="#"><i class="fa-regular fa-eye"></i></a>-->
                                                    <a class="btn btn-warning btn-sm" href="{{ route('typeavaliseurs.edit', ['typeavaliseur'=>$typeavaliseur->id])  }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                                    <a class="btn btn-danger btn-sm" href="{{ route('typeavaliseurs.delete', ['typeavaliseur'=>$typeavaliseur->id])  }}"><i class="fa-solid fa-trash-can"></i></a>
                                                </td>
