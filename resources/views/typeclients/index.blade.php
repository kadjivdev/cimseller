                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">liste des types Client</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                            ...
                            <div class="modal fade" id="modal-default">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ route('typeclients.store') }}">
                                            @csrf
                                ...
                                <table id="example1" class="table table-bordered table-striped table-sm"  style="font-size: 12px">
                                    ...
                                    @if ($typeclients->count() > 0)
                                        ...
                                        @foreach($typeclients as $typeclient)
                                            <tr>
                                                <td>{{ $compteur++ }}</td>
                                                <td class="ml-5 pr-5">{{ $typeclient->libelle }}</td>
                                                <td class="text-center">
                                                    <!--<a class="btn btn-success btn-sm" href="#"><i class="fa-regular fa-eye"></i></a>-->
                                                    <a class="btn btn-warning btn-sm" href="{{ route('typeclients.edit', ['typeclient'=>$typeclient->id])  }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                                    <a class="btn btn-danger btn-sm" href="{{ route('typeclients.delete', ['typeclient'=>$typeclient->id])  }}"><i class="fa-solid fa-trash-can"></i></a>
                                                </td>
