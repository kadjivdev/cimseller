    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Types Documents</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Acceuil</a></li>
                            <li class="breadcrumb-item active">Liste des types Documents</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Nouveau Type Document</h4>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form method="POST" action="{{ route('typedocuments.store') }}">
                                            @csrf
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <a href="{{ route('typedocuments.index') }}" class="btn btn-sm btn-secondary btn-block">
                                ...
                                <table id="example1" class="table table-bordered table-striped table-sm"  style="font-size: 12px">
                                    ...
                                    @if ($typedocuments->count() > 0)
                                        ...
                                        @foreach($typedocuments as $typedocument)
                                            <tr>
                                                <td>{{ $compteur++ }}</td>
                                                <td class="ml-5 pr-5">{{ $typedocument->libelle }}</td>
                                                <td class="text-center">
                                                    <!--<a class="btn btn-success btn-sm" href="#"><i class="fa-regular fa-eye"></i></a>-->
                                                    <a class="btn btn-warning btn-sm" href="{{ route('typedocuments.edit', ['typedocument'=>$typedocument->id])  }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                                    <a class="btn btn-danger btn-sm" href="{{ route('typedocuments.delete', ['typedocument'=>$typedocument->id])  }}"><i class="fa-solid fa-trash-can"></i></a>
                                                </td>
