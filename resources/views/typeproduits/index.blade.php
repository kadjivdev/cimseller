                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Listes des types de produit</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        @endif
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Nouveau type produit</h4>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <form method="POST" action="{{ route('typeproduits.store') }}">
                                            @csrf
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped table-sm"  style="font-size: 12px">
                                    ...
                                    <tbody>
                                    @if ($typeproduits->count() > 0)
                                        <?php $compteur=1; ?>
                                        @foreach($typeproduits as $typeproduit)
                                            <tr>
                                                <td>{{ $compteur++ }}</td>
                                                <td class="ml-5 pr-5">{{ $typeproduit->libelle }}</td>
                                                <td class="text-center">
                                                    <!--<a class="btn btn-success btn-sm" href="#"><i class="fa-regular fa-eye"></i></a>-->
                                                    <a class="btn btn-warning btn-sm" href="{{ route('typeproduits.edit', ['typeproduit'=>$typeproduit->id])  }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                                    <a class="btn btn-danger btn-sm" href="{{ route('typeproduits.delete', ['typeproduit'=>$typeproduit->id])  }}"><i class="fa-solid fa-trash-can"></i></a>
                                                </td>
                                                ...
                                                <!-- <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-md-right dropdown-menu-icon-list drop text-sm">
                                                            <a class="dropdown-item" href=""><i class="nav-icon fa-brands fa-product-hunt"></i> Produits</a>
                                                        </div>
                                                    </div>
                                                </td> -->
                                            </tr>
