                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Nouvelle visite technique</li>
                        </ol>
                    </div>
                </div>
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        <div class="card card-secondary">
                            <div class="card-header">
                                <h3 class="card-title">Ajouter une nouvelle visite technique</h3>
                            </div>
                            <form method="POST" action="{{ route('visitetechniques.store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-control-sm select2" name="libelle" style="text-transform: capitalize; width:100%;" required>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="dateFin" class="form-control form-control-sm @error('dateFin') is-invalid @enderror" name="dateFin"  value="{{ old('dateFin') }}"  autocomplete="dateFin" autofocus required>
                                                @error('dateFin')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                                @error('dateDebut')
