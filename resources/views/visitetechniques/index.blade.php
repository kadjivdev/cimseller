                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Visites Techniques</li>
                        </ol>
                    </div>
                </div>
                <div class="row mb-2">
                            ...
                            <div class="card">
                                ...
                                <div>
                                    <div class="card-head pt-3 pl-4 pr-4 row">
                                        <div class="col-sm-6">
                                            <a class="btn btn-success btn-sm" href="{{route('visitetechniques.create', ['id' => $camions->id])}}">
                                    ...
                                    <h4 class="text-center">Listes des visites techniques</h4>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-12 table-responsive">
                                                <table id="example1" class="table table-sm table-bordered table-striped" style="font-size: 12px">
                                                    ...
                                                    <tbody>
                                                        @if ($camions->count() > 0)
                                                            <?php $compteur=1; ?>
                                                            @foreach($camions->visitetechniques as $visitetechnique)
                                                                <tr>
                                                                    <td>{{ $compteur++ }}</td>
                                                                    <td class="text-center">{{ date_format(date_create($visitetechnique->dateDebut), 'd/m/Y') }}</td>
                                                                    <td class="text-center">{{ date_format(date_create($visitetechnique->dateFin), 'd/m/Y') }}</td>
                                                                    <td class="text-center">{{ $visitetechnique->libelle }}</td>
                                                                    <td>@if($visitetechnique->document)<a  class="btn btn-success btn-block text-white btn-sm" href="{{ asset('storage/'.$visitetechnique->document) }}" target="_blank"><i class="fa-solid fa-file-pdf mr-2"></i><b>Ouvrir Visite Technique</b></a>@endif</td>
                                                                    <td class="text-center">
                                                                        <a class="btn btn-warning btn-sm" href="{{ route('visitetechniques.edit', ['camion_id'=>$camions->id, 'visitetechnique_id'=>$visitetechnique->id]) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                                                        <a class="btn btn-danger btn-sm" href="{{ route('visitetechniques.delete', ['camion_id'=>$camions->id, 'visitetechnique_id'=>$visitetechnique->id]) }}"><i class="fa-solid fa-trash-can"></i></a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        @endif
